...
@click.command()
@click.option('-f', '--from-format',
              help='source file format.', type=str, default="yaml")
@click.option('-t', '--to-format',
              help='distination file format.', type=str, default="xlsx")
@click.option('-o', '--output',
              help='excel file name', type=str, default="output.xlsx")
